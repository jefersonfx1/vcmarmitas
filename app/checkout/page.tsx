...
import CepFreightField, { type FreightInfo } from "@/components/CepFreightField";
...
export default function CheckoutPage() {
  ...
  const qualifiesFreeFreight = subtotal >= FREE_FREIGHT_MIN;
  const freightPrice = freight?.available
  ...
  const inputCls =
    "w-full border border-gray-200 rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary-500";
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <CepFreightField
                  cep={form.cep}
                  orderTotal={subtotal}
                  qualifiesFreeFreight={qualifiesFreeFreight}
                  freight={freight}
                  ...
                  onLoading={setCepLoading}
                  onCouponReset={() => setAppliedCoupon(null)}
                />
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Rua *
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-6 sticky top-24">
              ...
              <div className="border-t border-gray-100 pt-4 mb-6 space-y-2">
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  ...
                  <span
                    className={
                      qualifiesFreeFreight && freight?.available
                ...
                {!qualifiesFreeFreight && freight?.available && (
                  <p className="text-xs text-gray-500">
                    Frete grátis a partir de {formatPrice(FREE_FREIGHT_MIN)}
                  </p>
                )}
                {discountFreight > 0 && (
                  <div className="flex justify-between text-sm text-green-700">
