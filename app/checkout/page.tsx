...
export default function CheckoutPage() {
  ...
  async function lookupCep(cepValue: string) {
    ...
    setCepLoading(true);
    try {
      const res = await fetch(`/api/cep?cep=${digits}&orderTotal=${encodeURIComponent(String(totalPrice()))}`);
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl border border-gray-100 p-6 sticky top-24">
              ...
              <div className="border-t border-gray-100 pt-4 mb-6 space-y-2">
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  <span>Frete</span>
                  <span className={qualifiesFreeFreight && freight?.available ? "text-green-700 font-medium" : ""}>
                    {freight?.available
                      ? qualifiesFreeFreight || freight.freeShipping
                        ? "Grátis"
